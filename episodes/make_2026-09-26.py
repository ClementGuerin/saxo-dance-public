...
shots = [
  ...
  shot(8, 'cave', [A('saxo', 'big_vegas_pointing_gesture', RX, RZ, at=0.0, lift=3.2, my=-3.2, myDur=0.8, air=True, arm='both', aim='up', upAt=0, upEnd=0.8),
       ...
       view((2.5, 0.5, 3.2), (1.6, 1.9, -0.5), 58, p1=(2.3, 0.55, 2.9), ly1=1.05), tied=True, rope=True, stars=['saxo', 'sadi']),
  ...
  shot(76, 'pearl', [A('saxo', 'shuffle', -2.2, -3.4, face='camera', hold='gcarrot'), A('sadi', 'happy_walk', -3.4, -2.8, mx=0.6, mz=-0.1, speed=1.4, face='world', yaw=100), giant('yelling_in_anger', -16, -4, at=4.0)],
       "(31.67) he dances harder; behind him Sadi climbs aboard, freed and soaked",
       view((0.4, 1.1, -1.8), (-2.9, 1.25, -2.9), 58), stars=['saxo', 'sadi'], **FOAM),
  ...
  shot(120, 'pearl', [A('sadi', 'emotional_waving_forward', 6.2, -1.2, mx=2.6, mz=3.4, lift=SEA + 0.12, face='camera')],
       "(50.0) Sadi rows away in the lifeboat and waves bye-bye (his point of view from the rail)",
       view((4.4, 1.25, -1.8), (7.6, -1.2, 0.6), 52), boat=[6.2, -1.2, 8.8, 2.2], stars=['sadi'], **FOAM2),
  ...
  shot(128, 'pearl', [kob(at=3.0)],
       ...
       view((3.7, 0.95, 1.45), (2.85, 1.05, -0.4), 54, p1=(3.65, 0.95, 1.35)), chain=True, chainRing=RING2, stars=['kob'], **FOAM2),
  ...
  shot(138, 'pearl', [giant('yelling_in_anger', -10.5, -3.5, at=2.0), A('saxo', 'being_terrified_while_standing', **CHAINED, hold='gcarrot', at=6.0)],
       ...
       view((4.4, 1.0, -5.1), (-7.5, 2.8, -3.5), 62, p1=(3.8, 1.0, -4.95)), chain=True, chainRing=RING, jolt=True, stars=['saxo'], **FOAM2),
  ...
  shot(144, 'pearl', [A('saxo', 'being_surprised_and_looking_right', **CHAINED, hold='gcarrot', holdTo=0.1, at=0.3, toss={'at': 0.1, 'to': [CH[0] - 3.4, 1.5, CH[1] + 0.3], 'dur': 0.5, 'arc': 0.4})],
       "L10 (-60.50, 'away' at 59.95): pluck: the carrot shoots up out of his paw",
       view((-2.3, 1.15, -1.9), (CH[0], 1.2, CH[1]), 52, p1=(-2.2, 1.15, -2.0)), chain=True, chainRing=RING, stars=['saxo'], **FOAM2),
  shot(146, 'pearl', [A('saxo', 'being_terrified_while_standing', **CHAINED, at=2.8), giant('bored_idle', -12, -3.5, my=-14, myAt=0.38, myDur=0.45, arm='R', aim=[0.3, 0.85, 0.45], upAt=-0.3, hold='gcarrot', holdScale=0.5)],   # the carrot held up in front of her cheek (not inside her head), then down she goes
       ...
       view((24, 5, -6), (-12, 3.0, -3.5), 48), chain=True, chainRing=RING, stars=['compote'], **FOAM2),
  # ================= the outro and the button =================
  shot(148, 'pearl', [A('saxo', 'laughing_standing', **CHAINED, at=1.0, hold='gcarrot', holdFrom=1.0, arm='R', aim='toast', upAt=1.0)],
       "(61.67) calm again. Alone, chained, he sighs... grins, and pulls a SECOND golden carrot out of his waistcoat",
       view((-1.9, 0.95, -2.2), (CH[0], 1.1, CH[1]), 50, p1=(-1.8, 0.95, -2.35)), chain=True, chainRing=RING, calm=True, stars=['saxo']),
  shot(156, 'pearl', [kob('pointing_while_seated', yaw=-134, hold=None, at=1.2, arm='R', aim=[0.0, 0.25, 0.97], upAt=0)],
       ...
       view((1.45, 1.0, -1.75), (2.85, 1.05, -0.4), 50, p1=(1.55, 1.0, -1.65)), chain=True, chainRing=RING, calm=True, stars=['kob']),
