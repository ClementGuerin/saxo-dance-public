...
export const SCRIPTS = {
  kob: s => ({
    ...
    nodes: {
      ...
      stats: { say: ['I track your views. For science.', 'Not because I care. The stats island is west, over the bridge.'], choices: [{ text: 'Take me there!', act: 'stats' }, { text: 'You DO care!', to: 'care' }] },
      care: { say: ['…', 'Unplugging your TV now.'], choices: [{ text: 'Okay, okay!', to: 'root2' }] },
  ...
  sadi: s => ({
    ...
    nodes: {
      ...
      news: { say: ['A new video drops every day!', "Kob pretends she doesn't watch them."], choices: [{ text: 'Where can I see them?', to: 'where' }, { text: 'How do you even make them?', to: 'made' }] },
      made: { say: ['With code. Every single frame.', "And it's all public! Cross the bridge east, to the GitHub island."], choices: [{ text: 'Take me there!', act: 'code' }, { text: 'Nerd island. Cool!', to: 'root2' }] },
